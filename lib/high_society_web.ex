defmodule HighSocietyWeb do
  ...
  defp html_helpers do
    quote do
      ...
      import Phoenix.HTML
      # Core UI components
      import HighSocietyWeb.CoreComponents

      # Common modules used in templates
      alias Phoenix.LiveView.JS
      alias HighSocietyWeb.Layouts
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: HighSocietyWeb.Router,
        statics: HighSocietyWeb.static_paths()
    end
  end
